...
args.add_argument("-c", "--config", required=False, default="config.json", help="Path to the configuration file")
...
vs = FileVideoStream("cars3.mp4").start()
time.sleep(2.0)
...
while True:
    ...
    for (objectID, centroid) in objects.items():
        ...
        current_object = trackableObjects[objectID]
